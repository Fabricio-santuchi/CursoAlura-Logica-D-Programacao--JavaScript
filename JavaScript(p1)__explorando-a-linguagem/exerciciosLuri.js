...
console.log(
  `\x1b[31m A soma de ${numero1} e ${numero2} é igual a ${soma}.\x1b[0m`
);
console.log("");
...
console.log(
  `\x1b[35m A frase "${frase}" tem ${numeroCaracteres} caracteres.\x1b[0m`
);
console.log("");
...
console.log(
  `\x1b[31m O Número maior é ${externos[0]} e o numero menor é ${externos[1]}.\x1b[0m`
);
console.log("");
